    ...
    <div class="max-w-3xl mx-auto px-8 py-12">
        <div class="bg-white rounded-2xl shadow-sm p-8 border border-purple-100">
            <div class="flex items-center gap-4 mb-8">
                ...
                <h1 class="text-2xl font-bold text-purple-800">Update  Experience</h1>
            </div>

            <form action="{{ route('candidats.experiences.update', $experience) }}" method="POST" class="space-y-6">
                @method('PUT')
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        <label class="text-sm font-bold mb-2 text-gray-700">Job Position</label>
                        <input type="text" name="poste" value="{{ old('poste') ?? $experience->poste }}" placeholder="e.g. Senior Developer" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="entreprise" value="{{ old('entreprise') ?? $experience->entreprise }}" placeholder="e.g. Google, Amazon..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="description" rows="4" placeholder="Describe your responsibilities and achievements..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">{{ old('description') ?? $experience->description }}</textarea>
