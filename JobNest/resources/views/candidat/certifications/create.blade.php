    ...
    <div class="max-w-3xl mx-auto px-8 py-12">
        <div class="bg-white rounded-2xl shadow-sm p-8 border border-purple-100">
            <div class="flex items-center gap-4 mb-8">
                ...
                <h1 class="text-2xl font-bold text-purple-800">Add Certification</h1>
            </div>

            <form action="{{ route('candidats.certifications.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="flex flex-col">
                    <label class="text-sm font-bold mb-2 text-gray-700">Certification Title</label>
                    <input type="text" name="titre" value="{{ old('titre') }}" placeholder="e.g. AWS Certified Cloud Practitioner" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="organisme" value="{{ old('organisme') }}" placeholder="e.g. Amazon Web Services, Google, Cisco..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="date" name="dateObtention" value="{{ old('dateObtention') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
