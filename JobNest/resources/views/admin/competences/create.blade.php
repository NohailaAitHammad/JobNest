    ...
    <div class="max-w-2xl mx-auto px-8 py-12">
        <div class="bg-white rounded-2xl shadow-sm p-8 border border-purple-100">
            <div class="flex items-center gap-4 mb-8">
                ...
                <h1 class="text-2xl font-bold text-purple-800">Add Global Skill</h1>
            </div>

            <form action="{{ route('admin.competences.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="flex flex-col">
                    <label class="text-sm font-bold mb-2 text-gray-700">Skill Label</label>
                    <input type="text" name="libelle" value="{{ old('libelle') }}" placeholder="e.g. React, Project Management, Python..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-600">
